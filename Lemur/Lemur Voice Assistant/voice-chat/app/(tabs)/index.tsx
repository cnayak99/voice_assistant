      ...
      <ThemedView style={styles.header}>
        ...
        <ThemedView style={styles.warningBanner}>
          <ThemedText style={styles.warningText}>
            {Platform.OS === 'web' 
              ? '⚠️ Allow microphone access in your browser when prompted.'
              : '⚠️ Some features may not work in Expo Go. For full functionality, use a development build.'
            }
          </ThemedText>
          <TouchableOpacity 
            style={styles.fallbackButton}
            onPress={useFallbackVoiceAssistant}
          >
